...
class RasterTileSource extends Evented implements Source {
    ...
    load() {
        ...
        loadTileJSON(this._options, (url) => { return this.map._transformRequest(url, resourceLoader.ResourceType.Source); }, (err, tileJSON) => {
            if (err) {
                this.fire('error', err);
            } else if (tileJSON) {
    ...
    loadTile(tile: Tile, callback: Callback<void>) {
        ...
        tile.request = resourceLoader.getImage(this.map._transformRequest(url, resourceLoader.ResourceType.Tile), (err, img) => {
            delete tile.request;
